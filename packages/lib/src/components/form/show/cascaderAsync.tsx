...
import { DuxCascaderAsync, useCascader } from '../../../components/cascader'

export const ShowCascaderAsync = defineComponent({
  name: 'ShowCascaderAsync',
  extends: DuxCascaderAsync,
  setup(props) {
