    ...
    <div class="flex lg:items-start gap-4 flex-col lg:flex-row">
      <div class="flex-1 flex flex-col gap-4 lg:w-1">
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-4">
          <div>
            <dux-stats-card title="今日任务" head-class="!py-2.5" content-class="!p-0">
              <template #extend>
              ...
              <n-scrollbar style="max-height: 681px">
                <dux-list class="p-4">
                  <dux-media v-for="(item, key) in taskData" :key="key">
                    {{ item.title }}
                    <template #image>
      ...
      <div class="flex-none flex flex-col gap-4 lg:w-86">
        ...
        <dux-stats-connect title="平台定制需求" desc="助力企业提升管理效率">
