...
import { DuxStatsAccount, DuxStatsBankcard, DuxStatsChart, DuxStatsRate, DuxStatsRateItem, DuxStatsSimple, DuxStatsSimpleItem } from './stats'
...
export default {
  install(app: App) {
    ...
    app.component('DuxStatsRate', DuxStatsRate)
    app.component('DuxStatsRateItem', DuxStatsRateItem)
    app.component('DuxStatsSimple', DuxStatsSimple)
    app.component('DuxStatsSimpleItem', DuxStatsSimpleItem)
    app.component('DuxStatsAccount', DuxStatsAccount)
    app.component('DuxStatsBankcard', DuxStatsBankcard)
    app.component('DuxStatsChart', DuxStatsChart)
  },
}
