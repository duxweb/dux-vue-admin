            ...
            return (
              <div
                class={clsx([
                  ...
                  editor?.selected.value === item.key ? 'bg-primary/10 border-primary border-solid' : 'border-gray-6 border-dashed',
                ])}
                key={item.key}
                onClick={(e) => {
                  e.stopPropagation()
                ...
                {editor?.selected.value === item.key && (
                  <>
                    <div class="absolute right-0 bottom-0  bg-primary flex px-1 rounded-tl z-1">
                      <div
                        class="p-1 text-gray-1/80 cursor-pointer  hover:text-gray-1"
                        onClick={() => {
                      ...
                      <div class="p-1 text-gray-1/80 cursor-pointer hover:text-gray-1">
                        <div
                    ...
                    <div class="absolute left-0 top-0  bg-primary p-1 text-gray-1 rounded-br z-1 editor-handle">
